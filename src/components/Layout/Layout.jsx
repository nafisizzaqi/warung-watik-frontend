...
export default function Layout({ children, user, onLogout, onCartClick }) {
  ...
  // Tentukan teks hero berdasarkan URL
  let pageTitle = "Selamat Datang di Warung Watik ";
  if (pathname === "/products") {
    pageTitle = "Menu Spesial Hari Ini 🍽️";
  } else if (pathname === "/testimoni") {
    pageTitle = "Lihat umpan balik pelanggan lain";
  }
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="bg-[#eeb626] text-brown-900 py-8 px-6 shadow-inner">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div>
            <div className="flex gap-2 items-center">
              ...
              <h2 className="text-2xl font-bold mb-2">Warung Watik</h2>
            </div>
            <p className="text-sm font-medium opacity-90">
              Tempat makan favorit warga!
              Masakan rumahan, sambal pedas, dan suasana hangat setiap hari.
            </p>
          </div>

          {/* Kolom 2 - Kontak */}
          <div>
            <h3 className="text-lg font-semibold mb-4 flex justify-center md:justify-start items-center gap-2">
              Kontak Kami
            </h3>
            <ul className="text-sm space-y-2">
              ...
              <li className="flex items-center justify-center md:justify-start gap-2">
                ...
                Jl. Mawar No. 45, Sleman, Yogyakarta
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start gap-4">
              ...
              {/* Tokopedia */}
              <a href="#" className="hover:scale-110 transition-transform" aria-label="Tokopedia">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 fill-brown-900 hover:fill-white transition-colors" viewBox="0 0 24 24">
                  <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10h7.5V14h-3v5H12a8 8 0 1 1 8-8v.5h2V12C22 6.477 17.523 2 12 2z" />
        ...
        {/* Garis bawah + credit */}
        <div className="border-t border-yellow-300 mt-8 pt-4 text-center text-sm font-medium text-brown-800">
          © {new Date().getFullYear()} <span className="font-semibold">Warung Watik</span> — Rasa lokal, suasana kekeluargaan ❤️
